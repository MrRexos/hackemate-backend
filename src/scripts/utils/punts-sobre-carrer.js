/**
 * Coordenades de prova sobre la xarxa viària (OSRM nearest), dins del bbox urbà de Barcelona.
 */

const DEFAULT_OSRM = 'https://router.project-osrm.org';

/** Trama densa (Eixample, Sants, part de L’Hospitalet…); limita nord per evitar Collserola. */
...
/**
 * Genera `total` punts únics (arrodonits) sobre carrer dins del bbox.
 */
